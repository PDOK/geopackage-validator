...
def test_table_definitions_check_incorrect_geometry():
    ...
    assert diff[0]["R8"] == {
        ...
        "errors": [
            "Difference: Value of root['test_allcorrect']['columns'][0]['geometry_type_name'] changed from \"POLYGON\" to \"POINT\"."
        ],
    }
...
def test_table_definitions_check_incorrect_projection():
    ...
    assert diff[0]["R8"] == {
        ...
        "errors": [
            "Difference: Value of root['test_allcorrect']['columns'][0]['projection'] changed from 4326 to 4323."
        ],
    }
...
def test_table_definitions_check_incorrect_column_name():
    ...
    assert diff[0]["R8"] == {
        ...
        "errors": [
            "Difference: Value of root['test_allcorrect']['columns'][0]['column_name'] changed from \"geometry\" to \"geom\"."
        ],
    }
