...
def geometry_valid_check_query(dataset) -> Iterable[Tuple[str, str, str, str]]:
...
def geometry_valid_check(geometry_check_list: Iterable[Tuple[str, str, str, str]]):
